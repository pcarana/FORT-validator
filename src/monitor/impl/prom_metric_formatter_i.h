...
#ifndef SRC_MONITOR_IMPL_PROM_METRIC_FORMATTER_I_H
#define SRC_MONITOR_IMPL_PROM_METRIC_FORMATTER_I_H
 ...
 */
int prom_metric_formatter_destroy(prom_metric_formatter_t *);

/*
 * @brief API PRIVATE Loads the help text
 */
int prom_metric_formatter_load_help(prom_metric_formatter_t *, const char *,
    const char *);

/*
 * @brief API PRIVATE Loads the type text
 */
int prom_metric_formatter_load_type(prom_metric_formatter_t *, const char *,
    prom_metric_type_t);

/*
 * @brief API PRIVATE Loads the formatter with a metric sample L-value
 * @param name The metric name
 * @param suffix The metric suffix. This is applicable to Summary and Histogram
 *        metric types.
 ...
 */
int prom_metric_formatter_load_l_value(prom_metric_formatter_t *, const char *,
    const char *, size_t, const char **, const char **);

/*
 * @brief API PRIVATE Loads the formatter with a metric sample
 */
int prom_metric_formatter_load_sample(prom_metric_formatter_t *,
    prom_metric_sample_t *);

/*
 * @brief API PRIVATE Loads a metric in the string exposition format
 */
int prom_metric_formatter_load_metric(prom_metric_formatter_t *,
    prom_metric_t *);

/*
 * @brief API PRIVATE Loads the given metrics
 */
int prom_metric_formatter_load_metrics(prom_metric_formatter_t *, prom_map_t *);

/*
 * @brief API PRIVATE Clear the underlying string_builder
 */
int prom_metric_formatter_clear(prom_metric_formatter_t *);

/*
 * @brief API PRIVATE Returns the string built by prom_metric_formatter
 */
char *prom_metric_formatter_dump(prom_metric_formatter_t *);

#endif /* SRC_MONITOR_IMPL_PROM_METRIC_FORMATTER_I_H */
