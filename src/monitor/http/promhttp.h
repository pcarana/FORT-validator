...
#ifndef SRC_MONITOR_HTTP_PROMHTTP_H
#define SRC_MONITOR_HTTP_PROMHTTP_H
 ...
 * References:
 *   * MHD_FLAG:
 *     https://www.gnu.org/software/libmicrohttpd/manual/libmicrohttpd.html#microhttpd_002dconst
 ...
 *
 * @param active_registery The target prom_collector_registry_t*. If null is
 *        passed, the default registry is used.
 *        The registry MUST be initialized.
 */
void promhttp_set_active_collector_registry(prom_collector_registry_t *);

/*
 * @brief Starts a daemon in the background and returns a pointer to an
 *        HMD_Daemon.
 *
 * References:
...
#endif /* SRC_MONITOR_HTTP_PROMHTTP_H */
