...
#ifndef SRC_MONITOR_DEF_PROM_METRIC_SAMPLE_H
#define SRC_MONITOR_DEF_PROM_METRIC_SAMPLE_H
...
/*
 * @brief Add the r_value to the sample. The value must be greater than or equal
 *        to zero.
 ...
 * @param self The target prom_metric_sample_t*
 * @param r_value The double to subtract from the prom_metric_sample_t* provided
 *        by self
 * @return Non-zero integer value upon failure
 */
 ...
 * @param self The target prom_metric_sample_t*
 * @param r_value The double which will be set to the prom_metric_sample_t*
 *        provided by self
 * @return Non-zero integer value upon failure
 */
int prom_metric_sample_set(prom_metric_sample_t *, double);

#endif /* SRC_MONITOR_DEF_PROM_METRIC_SAMPLE_H */
