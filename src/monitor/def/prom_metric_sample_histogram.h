...
#ifndef SRC_MONITOR_DEF_PROM_METRIC_SAMPLE_HISTOGRAM_H
#define SRC_MONITOR_DEF_PROM_METRIC_SAMPLE_HISTOGRAM_H
...
/*
 * @brief Observe the double for the given
 *        prom_metric_sample_histogram_observe_t
...
#endif /* SRC_MONITOR_DEF_PROM_METRIC_SAMPLE_HISTOGRAM_H */
